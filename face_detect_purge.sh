...
face_recognition /workspace/cropped/ /workspace/stable-diffusion-webui/outputs/txt2img-images/ --cpus -1 --tolerance 0.55 > recognized.txt
...
rm /workspace/stable-diffusion-webui/outputs/txt2img-images/*
